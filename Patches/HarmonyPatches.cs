...
namespace BlueLeakTest
{
    ...
    internal static class MultiplePawnRacesAtStart
    {
        private static void Postfix(ref Pawn __result)
        {
            ...
            if(Faction.OfPlayer.def.basicMemberKind != AndroidTiers.PawnKindDefOf.AndroidT2ColonistGeneral) {
                return;
            }
            else {
                Random rnd = new Random();
                ...
                switch(rnd.Next(1, 3)) {
                    case 1:
                        request = new PawnGenerationRequest(AndroidTiers.PawnKindDefOf.AndroidT2ColonistGeneral, Faction.OfPlayer, PawnGenerationContext.PlayerStarter, -1, true, false, false, false, true, TutorSystem.TutorialMode, 20f, false, true, true, false, false, false, false);
                        break;
                    case 2:
                        request = new PawnGenerationRequest(AndroidTiers.PawnKindDefOf.AndroidT1ColonistGeneral, Faction.OfPlayer, PawnGenerationContext.PlayerStarter, -1, true, false, false, false, true, TutorSystem.TutorialMode, 20f, false, true, true, false, false, false, false);
                        break;
                    default:
