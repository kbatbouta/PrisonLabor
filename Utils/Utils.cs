...
namespace AndroidTiers
{
    public static class Utils
    {
        ...
        public static List<string> ExceptionAndroidList = new List<string> { "Android1Tier", "Android2Tier", "Android3Tier", "Android4Tier", "Android5Tier", "ATPP_Android2TX", "ATPP_Android3TX", "ATPP_Android4TX", "ATPP_Android2KTX", "ATPP_Android2ITX", "ATPP_Android2KITX", "ATPP_Android3ITX", "ATPP_Android4ITX" };
        public static List<string> ExceptionAndroidCorpseList = new List<string> { "Corpse_Android1Tier", "Corpse_Android2Tier", "Corpse_Android3Tier", "Corpse_Android4Tier", "Corpse_Android5Tier" };
        public static List<string> ExceptionAndroidListBasic = new List<string> { "Android1Tier", "Android2Tier", "ATPP_Android2TX", "ATPP_Android2KTX", "ATPP_Android2ITX" };
        ...
        {
            if(pawn.ATIsAndroidInit)
                return pawn.ATIsAndroid;
            pawn.ATIsAndroid = Utils.ExceptionAndroidList.Contains(pawn.def.defName);
            pawn.ATIsAndroidInit = true;
            return pawn.ATIsAndroid;
        }
        ...
        {
            if(pawn.ATIsBasicAndroidInit)
                return pawn.ATIsBasicAndroid;
            pawn.ATIsBasicAndroid = Utils.ExceptionAndroidListBasic.Contains(pawn.def.defName);
            pawn.ATIsBasicAndroidInit = true;
            return pawn.ATIsBasicAndroid;
        }
        ...
        {
            return pawn?.ATCompState?.isBlankAndroid ?? false;
        }
        ...
        public static void ShowFloatMenuAndroidCandidate(Pawn emitter, Action<Pawn> onClick)
        {
            ...
            foreach(var colon in emitter.Map.mapPawns.FreeColonistsAndPrisoners) {
                ...
                if(colon != emitter && !colon.Dead
                    ...
                    CompAndroidState cab = colon.ATCompState;
        ...
        public static void ShowFloatMenuPermuteOrDuplicateCandidate(Pawn emitter, Action<Pawn> onClick, bool excludeBlankAndroid = false)
        {
            ...
            //Listing des colons sauf ceux présents dans la liste d'exception (exp)
            foreach(var colon in emitter.Map.mapPawns.FreeColonistsAndPrisoners) {
                CompAndroidState cas = colon.ATCompState;
                ...
                if(colon != emitter && !colon.Dead
                    ...
                    CompSurrogateOwner cso = colon.ATCompSurrogateOwner;
            ...
            foreach(var c in Find.World.worldObjects.Caravans) {
                foreach(var p in c.pawns) {
                    if(!p.Dead
                        ...
                        CompAndroidState cas = p.ATCompState;
        ...
        public static Pawn spawnCorpseCopy(Pawn pawn, bool kill = true)
        {
            ...
            AlienRace.AlienPartGenerator.AlienComp alienComp = pawn.alienComp;
            if(alienComp != null) {
                string crownType = alienComp.crownType;

                AlienRace.AlienPartGenerator.AlienComp alienComp2 = p.alienComp;
                if(alienComp2 != null) {
                    alienComp2.crownType = crownType;
                }
            }
        ...
        public static void clearBlankAndroid(Pawn android)
        {
            if(android.IsBlankAndroid()) {
                CompAndroidState cas = android.ATCompState;
                if(cas != null) {
